  ...
  return (
    ...
    >
      <Image
        ...
        width={40}
        height={40}
        className="h-10 w-10 shrink-0 rounded-xl object-contain ring-1 ring-slate-200 dark:ring-white/10"
        unoptimized
      />
      {!collapsed ? (
        <div className="min-w-0 leading-tight">
          <p className="truncate font-bold tracking-tight text-slate-900 dark:text-white">GREENERY</p>
