                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <label className="text-sm">
                      ...
                      <span className="mt-1 block text-[11px] text-gray-500 dark:text-gray-400">
                        Same step as markup range ({cfg.markupMin}–
                        {cfg.markupMax}, step {cfg.markupStep}).
                      </span>
                    </label>
                    <label className="text-sm">
                      Hourly rate ($)
              ...
              >
                <section className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                  ...
                  <p className="mb-4 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    multiplies <code>qtyPerPlant × plant quantity</code>{" "}
                    (rounded up). Each material is referenced by its{" "}
                    <code>sourceId</code> in{" "}
                                ...
                                if (!recipe) {
                                  return (
                                    ...
                                    >
                                      ...
                                      >
                                        No recipe. Staging will be omitted for
                                        this combination.
                                        <button
                                          type="button"
                                    ...
                                    <td className="py-2" colSpan={4}>
                                      ...
                                      <div className="space-y-1">
                                        {recipe.components.map((comp, ci) => {
                                          const mat =
                                            stagingsData.stagings.find(
                                              (m) =>
                                                m.id === comp.materialSourceId,
                                            );
                                          return (
                                            <div
                                              key={`${recipe.id}-${ci}`}
